...
#     Team_File = pd.read.csv(f"{user_input}.csv")
#     User_Choice = int(input("Enter 1 if you want to see season team info: , Enter 2 if you want to see a specific date info: , Enter 3 if you want to see the team's total points over the season: "))
...
#   # def Get_Regular_Season_Total_Points(self):
#   #   Total_Score = 0
#   #   while self.Team_File._contains_(self.user_input):
#   #     if True:
#   #        Total_Score + self.Team_File._Result
#   #   return Total_Score

#   def PrintTeamInfo(self):
#     print("=== Team Info ===")
#     print(self.Team_File)
#   def PrintSpecificDateInfo(self):
#     print("=== Date Information ===")
#   def PrintRegularSeasonTotal(self):
#     print("=== Total Season Points ===")
...
#     PrintTeamInfo(self)
#   elif UserChoice == "2":
#     PrintSpecificDateInfo(self)
#   elif UserChoice == "3":
#     PrintRegularSeasonTotal(self)

# class ExportInfo(self):
#   def ExportAllTeamInfo(self):
#     with open("results.txt", 'w') as f:
#       f.write("The Team Information is: ", +str(Team_File))
#   def ExportSpecificDateLocation(self):
#     with open("results.txt", 'w') as f:
#       f.write("The Specific Date Info is: ", str(Date_Location))
#   def ExportRegularSeasonPoints(self):
#     with open("results.txt", 'w') as f:
#       f.write("The team's total points over the season was: ", str(Total_Score))
